...
object Lizard {
    ...
    private val lizardBeziers = listOf(
    ...
    private fun namedShapes(name: String, shapes: List<Shape>): List<Pair<String, Shape>> = shapes.map { Pair(name, it) }
    ...
    val lizardShapes = listOf(
            Pair("primary", lizardPath)
    ) + mainSpine + lizardEyesOuter + lizardEyesInner
