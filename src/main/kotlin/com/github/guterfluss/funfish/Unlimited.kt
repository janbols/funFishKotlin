...
object Unlimited {
    ...
    val corner1: (Int, LensPicture) -> LensPicture = (::corner)(::utile3)(side1)(side2)
    val corner2: (Int, LensPicture) -> LensPicture = (::corner)(::utile2)(side2)(side1)
    ...
    val aboveBand = (::bandify)(::aboveRatio)

    val besideBand = (::bandify)(::besideRatio)
